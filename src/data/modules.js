...
export const lore = {
  history: [
    ...
    'OpenPeppol governance and local authorities shape how the ecosystem grows across regions.',
    'A-NZ localisation brings GST-focused and trans-Tasman realities into the journey.'
  ],
  signals: [
    'Signal processing lives lower in the stack: it is about moving information physically and digitally.',
    'Peppol sits much higher up, where business meaning, message structure, and interoperable rules matter most.',
    'The side quest helps noobs understand the stack without pretending telecom engineering is the main job.'
  ]
};
